...
*All objects that are saved are from the original analysis - to run the prepandemic sensitivity analysis, no objects will be saved* 
...
```{r save prepandemic data}
if (prepandemic.31.Jan == TRUE){
  saveRDS(object = dat, file = paste0(data_path, "data_formatted_FA_january_31.rds"))
}

if (prepandemic.01.Mar == TRUE){
  saveRDS(object = dat, file = paste0(data_path, "data_formatted_FA_march_1.rds"))
}

if (prepandemic.23.Mar == TRUE){
  saveRDS(object = dat, file = paste0(data_path, "data_formatted_FA_march_23.rds"))
}
```
